...
function restock(base_url, picked_size, refresh_interval){
  var iv1 = setInterval(function(){
    $.ajax({
      ...
      var sizes_array = $(r).find("option");
      var available = $(r).find(".sold-out.button")[0] == undefined ? true : false;
      var name = $(r)[2].innerText.replace("Supreme: ", "");
      ...
      if(available){
        ...
        if(picked_size == '' || picked_size == 'any' || sizes_array == undefined){
          clearInterval(iv1);
